...
/**
 * Created by Abdul Sami on 9/9/2017.
 */
...
public class DateHijri {
    ...
    public static double[] kuwaiticalendar(Long time, int adj) {
    ...
    static String writeIslamicDate(Long date) {
        ...
        double[] iDate = kuwaiticalendar(date, 0);
//        String outputIslamicDate = wdNames[(int) iDate[4]] + ", " +
...
//                 + " " + iDate[7] + " AH";
    ...
    static String writeIslamicDateHomeFeed(int adj) {
        String[] wdNames = { "Ahad", "Ithnin", "Thulatha", "Arbaa", "Khams",
                "Jumuah", "Sabt" };
        String[] iMonthNames = { "Muharram", "Safar", "Rabi'ul Awwal",
                "Rabi'ul Akhir", "Jumadal Ula", "Jumadal Akhira", "Rajab",
        ...
        double[] iDate = kuwaiticalendar(new Date().getTime(), adj);
//        String outputIslamicDate = wdNames[(int) iDate[4]] + ", " +
        String outputIslamicDate = " - " + (int) iDate[5] + " " + iMonthNames[(int) iDate[6]] + " " + (int) iDate[7];
//                 + " " + iDate[7] + " AH";
